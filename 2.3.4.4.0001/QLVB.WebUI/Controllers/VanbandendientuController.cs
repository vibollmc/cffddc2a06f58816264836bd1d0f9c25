...
namespace QLVB.WebUI.Controllers
{
    public class VanbandendientuController : Controller
    {
        ...
        public VanbandendientuController(IVanbandientuManager vanban, ISessionServices session, 
                IEdxmlManager edxml, ITrucLienthongTinhManager trucLienthongTinhManager)
        {
            _vanban = vanban;
            _session = session;
            _edxml = edxml;
