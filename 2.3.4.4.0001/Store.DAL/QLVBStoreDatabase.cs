...
namespace Store.DAL
{
    public class QLVBStoreDatabase : DbContext
    {
        static QLVBStoreDatabase()
        {
            Database.SetInitializer<QLVBStoreDatabase>(null); // must be turned off before mini profiler runs
        }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Hoibaovanban>().ToTable("Hoibaovanban").HasKey(m => m.intid);  // thieu hoi bao van ban
