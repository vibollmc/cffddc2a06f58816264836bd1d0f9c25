...
namespace QLVB.Core.Implementation
{
    public class EdxmlManager : IEdxmlManager
    {
        ...
        private IVanbandientuManager _vbdtManager;
        ...
        public EdxmlManager(ICanboRepository canborepo,
            ...
            IVanbandientuManager vbdtManager
                )
        {
        ...
        public string Sender(int idvanban, int intloaivanban, DonviEdxmlViewModel donvi)
        {
            ...
            try
            {
                ...
                if (deliverKnobstickResponse.Status == "OK")
                {
                    foreach (var p in donvi.listdonvi)
                    {
                        // luu van ban gui dien tu
                        _vbdtManager._SaveGuiVanban(idvanban, (int)enumGuiVanban.intloaivanban.Vanbandi,
                                                    null, p.strtendonvi, (int)enumGuiVanban.intloaigui.Chinhphu);
                    }                    
                }
