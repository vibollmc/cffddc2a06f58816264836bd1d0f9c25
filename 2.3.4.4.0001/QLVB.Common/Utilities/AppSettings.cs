...
namespace QLVB.Common.Utilities
{
    public class AppSettings
    {
        ...
        public static string UserDeny
        {
            get { return GetString("UserDeny", ""); }
        }

        public static string NamTraCuuVanban
        {
            get { return GetString("NamTraCuuVanban", ""); }
        }
        ...
        public static bool IsAutoReceiveTructinh
        {
            get
            {
                return GetBool("IsAutoReceiveTructinh", false);
            }
        }
        public static bool IsAutoSendTructinh
        {
            get
            {
                return GetBool("IsAutoSendTructinh", false);
            }
        }
        ...
        {
            get { return GetString("ServiceEdxml", "https://lienthong.chinhphu.vn/ihorae"); }
        }
        ...
        {
            get { return GetBool("IsLDAP", false); }
        }
        public static string ldapServerName
        {
            get { return GetString("ldapServerName", "localhost"); }
        }
        public static int ldapServerPort
        {
            get { return GetInt("ldapServerPort", 389); }
        }
        public static string ldapUser
        {
            get { return GetString("ldapUser", ""); }
        }
        public static string ldapPass
        {
            get { return GetString("ldapPass", ""); }
        }
        public static string ldapDC
        {
            get { return GetString("ldapDC", ""); }
        }
        public static string ldapCN
        {
            get { return GetString("ldapCN", ""); }
        }
        ...
        {
            get { return GetBool("IsCA", false); }
        }
        #endregion IsCA

        #region DLTD

        public static bool IsUseDLTD
        {
            get { return GetBool("IsUseDLTD", false); }
        }
