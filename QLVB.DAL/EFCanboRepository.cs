...
namespace QLVB.DAL
{
    public class EFCanboRepository : ICanboRepository
    {
        ...
        public EFCanboRepository()
        {
            context = new QLVBDatabase();
        }
        ...
        public Canbo GetAllCanboByUserName(string strUsername)
        {
            return context.Canbos.FirstOrDefault(p => p.strusername == strUsername);
        }
