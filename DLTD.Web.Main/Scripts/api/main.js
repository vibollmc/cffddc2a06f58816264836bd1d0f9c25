...
function buildButton() {
    ...
    modalHtml += "<label class='control-label'>Văn bản trích yếu:</label>";
    modalHtml += "<textarea type='text' name='Trichyeu' rows='2' class='form-control' id='" + idButton + "Trichyeu' style='padding:2px 1px;'></textarea>";
    modalHtml += "</div>";
    modalHtml += "</td>";
    modalHtml += "</tr>";
    ...
    modalHtml += "<td>";
    modalHtml += "<div class='form-group'>";
    modalHtml += "<label class='control-label'>Ngày ký:</label><br/>";
    modalHtml += "<input name='Ngayky' class='form-control' id='" + idButton + "Ngayky'>";
    modalHtml += "</div>";
    modalHtml += "</td>";
...
function checkValidData() {
    ...
    var soKH = $("#" + idButton + "SoKH");
    if ($.trim(soKH.val()) == "") {
        valid = false;
        message += "<li>Yêu cầu nhập Số/Ký hiệu.</li>";
}
...
function addNew() {
    ...
    var comboDoKhan = $("#"+idButton+"DoKhan").data("kendoDropDownList");
