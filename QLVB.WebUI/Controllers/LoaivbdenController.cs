...
{
    public class LoaivbdenController : Controller
    {
        #region Constructor

        private ILoaivanbanManager _loaivb;
        public LoaivbdenController(ILoaivanbanManager loaivb)
        {
            _loaivb = loaivb;
        }
        ...
        {
            return _loaivb.GetLoaivanban((int)enumPhanloaiVanban.intloai.vanbanden);
        }
        ...
        {
            int kq = _loaivb.SaveLoaivanban(model, (int)enumPhanloaiVanban.intloai.vanbanden);
