...
namespace QLVB.WebUI.Controllers
{
    public class VanbandiController : Controller
    {
        ...
        public VanbandiController(IVanbandiManager vanban, ISessionServices session, IMailManager mail, IEdxmlManager edxml)
        {
            _vanban = vanban;
            _session = session;
            _mail = mail;
