...
namespace QLVB.WebUI.Controllers
{
    public class HosoController : Controller
    {
        ...
        public ActionResult PhanXLNhieuVB(string idvanban, FormCollection collection)
        {
            ...
            {
                return RedirectToAction("PhanXLNhieuVB", "Vanbanden");
            }
        ...
        public ActionResult XulyHoso(int id)
        {
        ...
        [ChildActionOnly]
        public ActionResult _ToolbarXuly(int id)
        {
            ToolbarXulyViewModel tbar = _hoso.GetToolbarXuly(id);
