...
namespace QLVB.WebUI.Controllers
{
    public class TinhhinhxulyController : Controller
    {
        ...
        public ActionResult _TonghopVBDen(int iddonvi, string strngaybd, string strngaykt, int idloaingay, int idsovb)
        {
            ...
            _session.InsertObject("idloaingay", idloaingay);
            _session.InsertObject("idsovb", idsovb);
        ...
        // List van ban den
        //=====================================================
        public ActionResult ListVanbanDen(int intloai, int iddonvi, int idcanbo, string strngaybd, string strngaykt,
