...
namespace QLVB.WebUI.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(IAccountManager account, ISessionServices session)
        {
            _account = account;
            _session = session;
        }
        ...
        public ActionResult Login(string returnUrl)
        {
            ...
            var model = new DTO.Account.LoginViewModel {TenDonvi = _account.GetTenDonvi()};
        ...
        public ActionResult LogOff(string returlUrl)
        {
            AuthenticationManager.SignOut();
            _session.ClearAllObject();
            if (string.IsNullOrWhiteSpace(returlUrl)) return RedirectToAction("Login", "Account");
