...
* ===============================================
* fix bug by vudq
* fix bug in IE (line 17) and menu (line 180)
*/
;(function(window) {
    var
      ...
      // ============ fix bug in IE====================
      isTouchDevice = Modernizr ? Modernizr.touch : !!(('ontouchstart' in window) || (navigator.msMaxTouchPoints > 0)),
...
;(function($, Metis) {
    ...
    Metis.metisAnimatePanel = function () {
        ...
        var $body = $('body'),
              ...
              $rightToggle = $('.toggle-right'),
              $count = 0;
        //console.log(Metis.buttonPressedEvent);
      if($('#left').length){
