    ...
    public class SecurityServices
    {
        public static ISecurityConfiguration SetupFluentSecurity()
        {
            SecurityConfigurator.Configure(configuration =>
            {
                ...
                configuration.For<TinhhinhxulyController>(x => x.ListVanbanDen(1, 1, 1, "", "", 1, 1, true)).RequireAnyRole(RoleTinhhinhxulyVBDen.Truycap);
                ...
                // xu ly van ban
                configuration.For<HosoController>(x => x.XulyHoso(1,1)).RequireAnyRole(RoleVanbanden.Xulyvb);
                ...
                configuration.For<VanbandidientuController>(x => x._ForceSendVBToUBT()).RequireAnyRole(RoleCauhinhhethong.Truycap);
                configuration.For<VanbandidientuController>(x => x._SendVBToUBT()).RequireAnyRole(RoleVanbandi.GuiEmail);
                ...
                configuration.For<TracuuLuutruController>(x => x.CapnhatVanban(1, 1)).RequireAnyRole(RoleTracuuVanbandi.Luutruvanban);
