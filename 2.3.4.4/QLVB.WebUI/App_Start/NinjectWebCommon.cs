...
namespace QLVB.WebUI.App_Start
{
    ...
    public static class NinjectWebCommon
    {
        ...
        private static void RegisterServices(IKernel kernel)
        {
            ...
            kernel.Bind<ILuutruVanbanRepository>().To<EFLuutruVanbanRepository>();

            kernel.Bind<ILogGuiTonghopVBRepository>().To<EFLogGuiTonghopVBRepository>();
            kernel.Bind<ITonghopVanbanRepository>().To<EFTonghopVanbanRepository>();
            ...
            kernel.Bind<ITrucLienthongTinhManager>().To<TrucLienthongTinhManager>();
            ...
            // CA
            kernel.Bind<QLVB.Common.Certificate.ICheckCA>().To<QLVB.Common.Certificate.CheckCA>();
            ...
            kernel.Bind<IStoreLuutruVanbanRepository>().To<EFStoreLuutruVanbanRepository>();
            ...
            kernel.Bind<Store.Core.Contract.ITracuuLuutruManager>().To<Store.Core.Implementation.TracuuLuutruManager>();
