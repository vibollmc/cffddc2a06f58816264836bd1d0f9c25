...
namespace QLVB.DAL
{
    public class EFHosocongviecRepository : IHosocongviecRepository
    {
        ...
        {
            get { return context.Hosocongviecs.AsNoTracking(); }
        }
        ...
        public int Them(Hosocongviec hs)
        {
            try
            {
                ...
                Hosocongviec hoso = new Hosocongviec();
                hoso = hs;
                hoso.inttrangthai = (int)enumHosocongviec.inttrangthai.Dangxuly;

                context.Hosocongviecs.Add(hoso);
                context.SaveChanges();
                var intid = hoso.intid;
                context.Hosocongviecs.AsNoTracking();
                return intid;
            }
            catch (Exception ex)
            {
