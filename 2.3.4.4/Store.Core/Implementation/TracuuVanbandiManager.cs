...
namespace Store.Core.Implementation
{
    public class TracuuVanbandiManager : ITracuuVanbandiManager
    {
        ...
        private IStoreLuutruVanbanRepository _luutruStoreRepo;
        ...
        public TracuuVanbandiManager(IStoreVanbandiRepository vanbandiRepo, IStoreFileManager fileManager,
                ...
                IStoreLuutruVanbanRepository luutruStoreRepo
                )
        {
            ...
            _role = role;
            _luutruStoreRepo = luutruStoreRepo;
        }
        #endregion Constructor

        #region ListVanban

        public QLVB.DTO.TracuuVanbandi.ToolbarViewModel GetToolbar()
        {
            string strDisplay = "normal";
            string strNone = "none";
            QLVB.DTO.TracuuVanbandi.ToolbarViewModel tbar = new QLVB.DTO.TracuuVanbandi.ToolbarViewModel();
            tbar.Luutru = _role.IsRole(RoleTracuuVanbandi.Luutruvanban) == true ? strDisplay : strNone;
        ...
        public DetailVBDiViewModel GetViewDetail(int idvanban)
        {
            ...
            var _lt = _luutruStoreRepo.LuutruVanbans
