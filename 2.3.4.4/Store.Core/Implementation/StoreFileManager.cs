...
{
    public class StoreFileManager : IStoreFileManager
    {
        #region Constructor
        ...
        public StoreFileManager(ISessionServices session, IStoreAttachVanbanRepository fileVBRepo, IStoreAttachHosoRepository fileHS)
        {
            _session = session;
